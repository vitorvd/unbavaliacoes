...
public class AvaliacaoProfessorEndpoint {
    ...
    public ResponseEntity<List<AvaliacaoProfessor>> listarAvaliacoesTurma(@PathVariable Integer professorId) {
        List<AvaliacaoProfessor> avaliacoesTurma = servico.listarAvaliacoesTurma(professorId);
