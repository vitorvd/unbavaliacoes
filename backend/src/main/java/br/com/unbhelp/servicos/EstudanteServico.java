...
public class EstudanteServico {
    ...
    public Estudante autenticar(Estudante estudante) {
        if(estudante.getMatricula() == null || estudante.getSenha() == null)
            throw new IllegalArgumentException("Os campos: Matricula e senha são obrigatórios.");
        ...
        if(!estudante.getSenha().equals(estudanteExistente.getSenha()))
            throw new IllegalStateException("A senha está incorreta.");
